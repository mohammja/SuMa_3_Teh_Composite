public class Main {
    ...
    /*    Motherboard motherBoard = new Motherboard(1000);
        Processor processor = new Processor(600);
        NetworkCard networkCard = new NetworkCard(50);
        GraphicsCard graphicsCard = new GraphicsCard(800);
        ...
        Case firstCase = factoryA.createCase();
        ...
        DesktopComputer firstPC = new DesktopComputer(firstMB, firstCase);
        System.out.println("Total price if you buy from the factory A: " + firstPC.getPrice() + " €");

        Case secondCase = factoryB.createCase();
        ...
        DesktopComputer secondPC = new DesktopComputer(secondMB, secondCase);
